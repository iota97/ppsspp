...
void GameSettingsScreen::CreateViews() {
	...
	tint->SetDisabledPtr(&g_Config.bUIMonthlyColor);
	...
	saturation->SetDisabledPtr(&g_Config.bUIMonthlyColor);

	systemSettings->Add(new CheckBox(&g_Config.bUIMonthlyColor, sy->T("Monthly colors")));
